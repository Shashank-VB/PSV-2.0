...
with col4:
    uploaded_file = st.file_uploader("Upload PSV Excel File:", type=["xlsx"])
    df = None
...
for link_section_number, entry in st.session_state.get('entries', {}).items():
